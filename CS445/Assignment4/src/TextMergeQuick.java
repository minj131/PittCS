...
// QUICK SORT
	...
	// BASE CASE 5
	public static <T extends Comparable<? super T>>
	       void quickSort5(T[] a, int first, int last)
	{
	  if (last - first + 1 < 5)
	  {
	  ...
	  else
	  {
	    ...
	    quickSort5(a, first, pivotIndex - 1);
	    quickSort5(a, pivotIndex + 1, last);
	  } // end if
	} // end quickSort

	// BASE CASE 20
	public static <T extends Comparable<? super T>>
	void quickSort20(T[] a, int first, int last)
	{
		if (last - first + 1 < 20) {
			insertionSort(a, first, last);
		}
		else
		{
			...
			// sort subarrays Smaller and Larger
			quickSort20(a, first, pivotIndex - 1);
			quickSort20(a, pivotIndex + 1, last);
		} // end if
	} // end quickSort

	// BASE CASE 100
	public static <T extends Comparable<? super T>>
	void quickSort100(T[] a, int first, int last)
	{
		if (last - first + 1 < 100) {
			insertionSort(a, first, last);
		}
		else
		{
			...
			// sort subarrays Smaller and Larger
			quickSort100(a, first, pivotIndex - 1);
			quickSort100(a, pivotIndex + 1, last);
		} // end if
	} // end quickSort

	// RANDOM PIVOT WITH BASE CASE 5
	public static <T extends Comparable<? super T>>
	void quickSortPivot(T[] a, int first, int last)
	{
		if (last - first + 1 < 5) {
			insertionSort(a, first, last);
		}
		else
		{
			...
			int pivotIndex = rngPartition(a, first, last);

			// Then recurse using base case 5
			quickSortPivot(a, first, pivotIndex - 1);
			quickSortPivot(a, pivotIndex + 1, last);
		} // end if
	} // end quickSort
	...
	private static <T extends Comparable<? super T>>
	int rngPartition(T[] a, int first, int last)
	{

		// Assertion: The pivot picked at random in the range of the first and last
