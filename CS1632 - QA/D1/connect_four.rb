...
def show_usage_and_exit
  ...
  puts '*x* should be a nonnegative integer that is 4 or greater'
  exit 1
end
...
#CHANGED: board size must be greater or equal to 4 & cannot be floating point
def check_args(args)
  args.count == 1 && args[0].to_i >= 0 && args[0] = Integer(args[0])
